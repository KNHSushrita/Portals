...
export class DetailsComponent implements OnInit {
  ...
  ngOnInit(): void {
    // this.uname = localStorage.getItem('uname');
      ...
      console.log(data);
      this.id = data['SOAP:Envelope']['SOAP:Body']['ns0:ZMM_VEN_DETAILS_KNH.Response']['E_IT_OUTPUT'].VENDOR._text;
      ...
      this.addr = data['SOAP:Envelope']['SOAP:Body']['ns0:ZMM_VEN_DETAILS_KNH.Response']['E_IT_OUTPUT'].ADDRESS._text;
      ...
      this.dist = data['SOAP:Envelope']['SOAP:Body']['ns0:ZMM_VEN_DETAILS_KNH.Response']['E_IT_OUTPUT'].DISTRICT._text;
      this.mobile = data['SOAP:Envelope']['SOAP:Body']['ns0:ZMM_VEN_DETAILS_KNH.Response']['E_IT_OUTPUT'].TELEPHONE._text;
