...
export class DetailsupdateComponent implements OnInit {
  ...
  //     console.log(data);
  //     this.id = data['SOAP:Envelope']['SOAP:Body']['ns0:ZMM_VEN_DETAILS_UPDATE_AKR.Response'].VENDOR;
  ...
  //     this.dist = data['SOAP:Envelope']['SOAP:Body']['ns0:ZMM_VEN_DETAILS_UPDATE_AKR.Response'].DISTRICT;
  //     this.addr = data['SOAP:Envelope']['SOAP:Body']['ns0:ZMM_VEN_DETAILS_UPDATE_AKR.Response'].ADDRESS;
  //     this.mobile = data['SOAP:Envelope']['SOAP:Body']['ns0:ZMM_VEN_DETAILS_UPDATE_AKR.Response'].TELEPHONE;
